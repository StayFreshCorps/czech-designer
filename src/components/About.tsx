    ...
    <section id="about" className="bg-ink text-paper">
      <Shell className="grid items-center gap-12 py-20 lg:grid-cols-12 lg:gap-16 lg:py-28">
        ...
        <div className="lg:col-span-7">
          ...
          <h2 className="mt-4 font-display text-[42px] leading-[0.92] font-semibold tracking-[-0.04em] lg:text-[64px]">
            The production
            <br />
            layer
          </h2>
          ...
          <dl className="mt-10 grid grid-cols-3 gap-6">
            {stats.slice(0, 3).map((stat) => (
              <div key={stat.id}>
                <dt className="font-display text-[28px] leading-none font-semibold tracking-[-0.04em] lg:text-[36px]">
                  {stat.value}
                </dt>
