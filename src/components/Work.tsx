  ...
  return (
    <section id="work" className="bg-ink text-paper">
      <Shell className="pb-20 lg:pb-28">
        <h2 className="max-w-3xl font-display text-[42px] leading-[0.92] font-semibold tracking-[-0.04em] lg:text-[64px]">
          Selected work.
          <br />
        ...
        >
          ...
          <div className="px-2 pb-4 lg:col-span-5 lg:px-0 lg:pb-0">
            ...
            <h3 className="mt-4 font-display text-[28px] leading-tight font-semibold group-hover:text-accent lg:text-[36px]">
              {featured.title}
            </h3>
          ...
          {rest.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-2 font-display text-[20px] leading-tight font-semibold group-hover:text-accent">
                  {project.title}
                </h3>
