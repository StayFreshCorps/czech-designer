  ...
  return (
    <section id="practice" className="bg-ink text-paper">
      <Shell className="pb-20 lg:pb-28">
        <h2 className="font-display text-[42px] leading-[0.92] font-semibold tracking-[-0.04em] lg:text-[64px]">
          Practice
        </h2>
        <div className="mt-12 grid gap-5 lg:grid-cols-3">
          {practices.map((item) => (
            ...
            >
              ...
              <h3 className="mt-8 font-display text-[22px] font-semibold">{item.title}</h3>
